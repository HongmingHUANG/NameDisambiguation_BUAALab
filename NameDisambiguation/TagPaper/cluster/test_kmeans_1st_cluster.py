...
tagged, centroids, dist_to_centroid = okm_local.kmeans(vecs,k,centroids,iter_num=30)
...
for j in range(k):
    ...
    with open("./test_kmeans/kmeans_30_"+str(j)+".txt", "w") as f:
...
print(centroids)
#np.save("./test_kmeans/kmeans_centroids", centroids)
